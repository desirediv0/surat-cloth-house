          ...
          >
            <CarouselContent className="-ml-2 md:-ml-4">
              {testimonials.map((testimonial, index) => (
                ...
                >
                  <div className="relative h-[500px]  rounded-2xl overflow-hidden shadow-lg group cursor-pointer">
                    {/* Background Image */}
                    <Image
                    ...
                    <div className="absolute inset-0 flex flex-col justify-end p-6 md:p-8">
                      ...
                      {/* Quote Text */}
                      <p className="text-white text-sm md:text-base font-medium leading-relaxed mb-4 z-10 relative">
                        {testimonial.quote}
                      </p>
                      ...
                      <div className="flex items-center gap-1 mb-4">
                        {[...Array(5)].map((_, i) => (
                          <Star
                            key={i}
                            className="w-4 h-4 md:w-5 md:h-5 text-white fill-white"
                          />
                        ))}
                      </div>
                      ...
                      <div className="flex items-center gap-3">
                        <div className="w-10 h-10 md:w-12 md:h-12 rounded-full flex items-center justify-center bg-[#136C5B] text-white font-bold text-base md:text-lg shadow-lg">
                          {testimonial.name.charAt(0)}
                        </div>
                        <div>
                          <h3 className="text-white font-bold text-sm md:text-base">
                            {testimonial.name.charAt(0)} {testimonial.name}
                          </h3>
                          <p className="text-white/80 text-xs md:text-sm uppercase">
